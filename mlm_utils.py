...
# the HuggingFace MLM training script and were extracted from the main script to integrate
...
# Original Work:
# https://github.com/Adapter-Hub/adapter-transformers/blob/v2/examples/language-modeling/run_mlm.py
...
@dataclass
class DomainDataTrainingArguments:
    """
